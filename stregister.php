...
$pageTitle = "Student Registration | CodeMaster LMS";
include 'header.php';
?>
                ...
                <div class="row g-0">
                    <div class="col-md-5 d-none d-md-block bg-gradient-primary text-white p-5">
                        <div class="d-flex flex-column h-100 justify-content-center">
                            <h3 class="fw-bold mb-4">Join CodeMaster LMS</h3>
                            <p class="mb-0">Start your learning journey with industry experts.</p>
                            <div class="mt-auto">
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="text-center pt-3">
                                <p class="text-muted mb-0">Already have an account? 
                                    <a href="stlogin.php" class="text-primary fw-bold">Login here</a>
                                </p>
                            </div>
                        </div>
                    </div>
