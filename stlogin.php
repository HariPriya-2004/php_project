...
$pageTitle = "Student Login | CodeMaster LMS";
include 'header.php';
?>
                ...
                <div class="row g-0">
                    <div class="col-md-5 d-none d-md-block bg-gradient-primary text-white p-5">
                        <div class="d-flex flex-column h-100 justify-content-center">
                            <h3 class="fw-bold mb-4">Welcome Back, Student!</h3>
                            <p class="mb-0">Continue your learning journey with CodeMaster LMS.</p>
                            <div class="mt-auto">
                    ...
                    <div class="col-md-7">
                        <div class="card-body p-5">
                            ...
                            <div class="text-center pt-3">
                                <p class="text-muted mb-0">New student? 
                                    <a href="stregister.php" class="text-primary fw-bold">Create an account</a>
                                </p>
                            </div>
                        </div>
                    </div>
